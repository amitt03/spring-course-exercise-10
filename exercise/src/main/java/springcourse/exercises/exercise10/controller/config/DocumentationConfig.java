...
public class DocumentationConfig extends WebMvcConfigurerAdapter {
    ...
    public ApiDocumentationController apiDocumentationController() {
        ...
        apiDocumentationController.setBaseControllerPackage("springcourse.exercises.exercise10.controller");
        apiDocumentationController.setBaseModelPackage("springcourse.exercises.exercise10.model");
